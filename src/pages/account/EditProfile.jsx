    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-16 px-4 pb-10">
        ...
        <div className="py-4 space-y-4 border-b border-gray-100">
          <p className="font-semibold text-gray-800">Basic Info</p>
          {[
            { label: 'Full Name', name: 'fullName', placeholder: 'Your full name' },
            { label: 'Bio', name: 'bio', placeholder: 'Tell us about yourself' },
            { label: 'Location', name: 'location', placeholder: 'City, Country' },
            { label: 'Website', name: 'website', placeholder: 'https://yourwebsite.com' },
          ].map((field) => (
            <div key={field.name}>
        ...
        <div className="py-4 space-y-3 border-b border-gray-100">
          <p className="font-semibold text-gray-800">Add Experience</p>
          {[
          ...
          <button
            ...
            className="bg-[#2B4593] text-white text-sm font-semibold px-4 py-2 rounded-xl"
          >
            Add Experience
          </button>
        </div>
        ...
        {/* Education */}
        <div className="py-4 space-y-3 border-b border-gray-100">
          <p className="font-semibold text-gray-800">Add Education</p>
          {[
        ...
        <div className="py-4 space-y-3">
          <p className="font-semibold text-gray-800">Add Skill</p>
