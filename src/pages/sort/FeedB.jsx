...
const categories = ['All', 'Agriculture', 'Transport', 'Handicrafts', 'Local Trade', 'Food', 'Health', 'Daily Life']
...
function FeedB() {
  ...
  const handleCategory = (cat) => {
    ...
    const keywords = {
      'Agriculture': ['farm', 'crop', 'harvest', 'agriculture', 'plant', 'soil', 'farmer', 'field'],
      'Transport': ['drive', 'transport', 'vehicle', 'road', 'travel', 'delivery', 'truck', 'bus'],
      'Handicrafts': ['craft', 'handmade', 'stitch', 'tailor', 'weave', 'art', 'design', 'pottery'],
      'Local Trade': ['shop', 'sell', 'buy', 'market', 'trade', 'business', 'store', 'price'],
      'Food': ['food', 'cook', 'recipe', 'meal', 'eat', 'restaurant', 'kitchen', 'dish'],
      'Health': ['health', 'doctor', 'medicine', 'hospital', 'wellness', 'fitness', 'diet'],
      'Daily Life': ['today', 'morning', 'life', 'family', 'home', 'day', 'routine'],
    }
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      <div className="fixed top-0 left-0 right-0 bg-white border-b border-gray-100 px-4 py-3 z-50 flex items-center justify-between">
        <h1 className="text-base font-semibold text-gray-800">Public Feed</h1>
